                ...
                ElevatedButton(
                  onPressed: isButtonEnabled
                      ? () async {
                          ...
                          if (username.isEmpty) {
                            showErrorMessage('Nama Pengguna Harus Diisi.');
                          } else if (username.length < 3) {
                            showErrorMessage(
                                'Nama Pengguna Harus Terdiri Dari Minimal 3 Karakter Huruf.');
                          } else {
                            bool isNameValid =
                                RegExp(r"^[a-zA-Z\s]+$").hasMatch(username);
                            ...
                            if (isNameValid) {
                              ...
                              showErrorMessage(
                                  'Nama Pengguna Hanya Boleh Mengandung Huruf');
                            }
                          }
                        }
                      : null,
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        Image.asset(
          'assets/kebunrayabalikpapan.jpg',
